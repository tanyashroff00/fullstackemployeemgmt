						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#employeemanagement-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"employeemanagement-display": {
								"semanticObject": "employeemanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeemanagement",
									"url": sap.ui.require.toUrl("employeemanagement")
								}
							}
						}
					}
